...
define-command -override -hidden surround-init %{
  ...
  map -docstring 'delete' global surround d ': surround-delete<ret>'
  map -docstring 'change' global surround c ': surround-delete<ret>: surround<ret>'
...
define-command -hidden -override execute-keys-with-register -params 2 -docstring 'execute keys with register' %{
